            ...
            <div className="relative p-12 bg-gradient-to-br from-gray-50 to-white border border-gray-200">
              ...
              <div className="flex flex-col gap-4">
                ...
                {[
                  ...
                  { name: 'TensorFlow', icon: <svg className="w-5 h-5" viewBox="0 0 24 24"><path fill="#FF6F00" d="M1.292 5.856L11.54 0v24l-4.095-2.378V7.603l-6.168 3.564.015-5.31zm21.416 5.393l-6.154-3.564v15.937L12.459 24V0l10.25 5.856-.001 5.393z"/></svg> },
